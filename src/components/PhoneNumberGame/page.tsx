      ...
      <div className="flex justify-center items-center p-4 h-screen">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 max-w-sm">
          <div className="p-6 text-center">
            <h3 className="mb-5 text-2xl font-mono">{`${numberToGuess.substring(0, 5)}-${numberToGuess.substring(5, 8)}-${numberToGuess.substring(8)}`}</h3>
            <h4 className="text-gray-600">Take the time you need to memorize it and start when you are ready</h4>
